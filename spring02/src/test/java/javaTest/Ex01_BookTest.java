...
public class Ex01_BookTest {
	...
	public void equalsTest() {
		...
		assertEquals(b1.author,"톨스토이"); // "톨스토이"
	...
	public void arrayEqualsTest() {
		...
		//5.3) 두배열의 순서, 값 모두 다른 경우
		//assertArrayEquals(a1,a4); // false
		
		//5.4) Book Type의 배열을 2개 만들고 비교
		//	=> 각 배열의 Data는 3개씩
		Book b1 = new Book("엄미현","죄와벌",9900);
		Book b2 = new Book("엄미현","죄와벌",9900);
		Book b3 = new Book("톨스토이","홍길동전",19900);
		Book[] B1= {b1,b2,b3};
		Book[] B2= {b1,b2, new Book("홍길동","홍길동전", 35000)};
		Book[] B3= {b1,b2,b3};
		
		//assertArrayEquals(B1,B2);	// false
		//assertArrayEquals(B1,B3);	// true
