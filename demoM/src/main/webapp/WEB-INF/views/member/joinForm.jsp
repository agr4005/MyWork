...
<head>
<meta charset="UTF-8">
<title>** Spring_Boot Mybatis Join **</title>
...
//	=> 오류가 없다면: switch 변수값을 true, 메세지 삭제
//	=> 오류가 있다면: switch 변수값을 false, 메세지 출력
...
<body>
<h2>** Spring_Boot Mybatis JoinForm **</h2>
<!--  ** FileUpLoad Form **
